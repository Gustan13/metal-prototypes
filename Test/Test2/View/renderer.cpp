...
: _pDevice( pDevice->retain() )
{
    ...
    importModel("Models/baoxiaoling.obj");
    buildMatrices();
    buildShaders();
//    buildBuffers();
}
...
void Renderer::importModel(const std::string pFile) {
    ...
    myModel = new Model("train", _pDevice);
    myModel->setModel(scene);
...
//        returnVertices[i][0] = mvertices[i].x;
//        returnVertices[i][1] = mvertices[i].y;
//        returnVertices[i][2] = mvertices[i].z;
//    }
//    
